...
async function run() {
  ...
  await getTodoLists(username, token).then(console.log).catch(console.error);
  ...
  await getTodos(todoListId, token).then(console.log).catch(console.error);

  await updateTodo(todoId, true, token).then(console.log).catch(console.error);

  await deleteTodo(todoId, token).then(console.log).catch(console.error);

  await deleteTodoList(todoListId, token)
    .then(console.log)
    .catch(console.error);

  await signUp("tonton", "rootroot").then(console.log).catch(console.error);
}
